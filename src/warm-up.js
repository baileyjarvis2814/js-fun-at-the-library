...
var sequel = `${title} 2: It's Mobing Time`
console.log(sequel, '<>>> sequel title?')
...
console.log(isShortStory, "<>>> short story?")
...
if (isFavorite = true) {
    ...
    console.log(`I've recently read the ${title} book.`)
}
...
var books = ["1984", "Dune", "Hamlet", "Jurassic Park", "The Odyssey"]
...
var belowTwoHundred = [34, 56, 110, 7, 18, 48, 62, 24, 98, 30, 51, 199]
